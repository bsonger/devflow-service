...
require_file "$ROOT_DIR/deployments/tekton/meta-service-preproduction-build-pipelinerun.yaml" "meta-service preproduction Tekton PipelineRun"
require_file "$ROOT_DIR/deployments/tekton/config-service-preproduction-build-pipelinerun.yaml" "config-service preproduction Tekton PipelineRun"
require_file "$ROOT_DIR/deployments/tekton/config-service-pipeline-run-template.yaml" "config-service Tekton PipelineRun template"
require_file "$ROOT_DIR/deployments/tekton/network-service-preproduction-build-pipelinerun.yaml" "network-service preproduction Tekton PipelineRun"
require_file "$ROOT_DIR/deployments/tekton/network-service-pipeline-run-template.yaml" "network-service Tekton PipelineRun template"
require_file "$ROOT_DIR/deployments/tekton/release-service-preproduction-build-pipelinerun.yaml" "release-service preproduction Tekton PipelineRun"
require_file "$ROOT_DIR/deployments/tekton/release-service-pipeline-run-template.yaml" "release-service Tekton PipelineRun template"
require_file "$ROOT_DIR/deployments/tekton/runtime-service-preproduction-build-pipelinerun.yaml" "runtime-service preproduction Tekton PipelineRun"
require_file "$ROOT_DIR/deployments/tekton/runtime-service-pipeline-run-template.yaml" "runtime-service Tekton PipelineRun template"
...
require_literal "$ROOT_DIR/docs/policies/docker-baseline.md" "Docker baseline config-service Tekton manifest" "deployments/tekton/config-service-preproduction-build-pipelinerun.yaml"
require_literal "$ROOT_DIR/docs/policies/docker-baseline.md" "Docker baseline network-service Tekton manifest" "deployments/tekton/network-service-preproduction-build-pipelinerun.yaml"
require_literal "$ROOT_DIR/docs/policies/docker-baseline.md" "Docker baseline release-service Tekton manifest" "deployments/tekton/release-service-preproduction-build-pipelinerun.yaml"
require_literal "$ROOT_DIR/docs/policies/docker-baseline.md" "Docker baseline runtime-service Tekton manifest" "deployments/tekton/runtime-service-preproduction-build-pipelinerun.yaml"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README config-service preproduction PipelineRun" "config-service-preproduction-build-pipelinerun.yaml"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README config-service template" "config-service-pipeline-run-template.yaml"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README network-service preproduction PipelineRun" "network-service-preproduction-build-pipelinerun.yaml"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README network-service template" "network-service-pipeline-run-template.yaml"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README release-service preproduction PipelineRun" "release-service-preproduction-build-pipelinerun.yaml"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README release-service template" "release-service-pipeline-run-template.yaml"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README runtime-service preproduction PipelineRun" "runtime-service-preproduction-build-pipelinerun.yaml"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README runtime-service template" "runtime-service-pipeline-run-template.yaml"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README config-service pre-production deployment" "deployments/pre-production/config-service.yaml"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README network-service pre-production deployment" "deployments/pre-production/network-service.yaml"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README runtime-service pre-production deployment" "deployments/pre-production/runtime-service.yaml"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README Istio shared ingress manifest" "deployments/pre-production/istio/shared-ingress.yaml"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README Istio shared ingress host" "devflow-pre.example.com"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README config-service edge subpath" "/config"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README network-service edge subpath" "/network"
require_literal "$ROOT_DIR/deployments/README.md" "deployments README runtime-service edge subpath" "/runtime"
...
require_literal "$ROOT_DIR/deployments/tekton/config-service-preproduction-build-pipelinerun.yaml" "config-service PipelineRun build args" "SERVICE_NAME=config-service --build-arg SERVICE_PORT=8082"
require_literal "$ROOT_DIR/deployments/tekton/config-service-pipeline-run-template.yaml" "config-service template build args" "SERVICE_NAME=config-service --build-arg SERVICE_PORT=8082"
require_literal "$ROOT_DIR/deployments/tekton/config-service-preproduction-build-pipelinerun.yaml" "config-service PipelineRun service label" "service: config-service"
require_literal "$ROOT_DIR/deployments/tekton/config-service-pipeline-run-template.yaml" "config-service template service label" "service: config-service"
require_literal "$ROOT_DIR/deployments/tekton/network-service-preproduction-build-pipelinerun.yaml" "network-service PipelineRun build args" "SERVICE_NAME=network-service --build-arg SERVICE_PORT=8086"
require_literal "$ROOT_DIR/deployments/tekton/network-service-pipeline-run-template.yaml" "network-service template build args" "SERVICE_NAME=network-service --build-arg SERVICE_PORT=8086"
require_literal "$ROOT_DIR/deployments/tekton/network-service-preproduction-build-pipelinerun.yaml" "network-service PipelineRun service label" "service: network-service"
require_literal "$ROOT_DIR/deployments/tekton/network-service-pipeline-run-template.yaml" "network-service template service label" "service: network-service"
require_literal "$ROOT_DIR/deployments/tekton/release-service-preproduction-build-pipelinerun.yaml" "release-service PipelineRun build args" "SERVICE_NAME=release-service --build-arg SERVICE_PORT=8083"
require_literal "$ROOT_DIR/deployments/tekton/release-service-pipeline-run-template.yaml" "release-service template build args" "SERVICE_NAME=release-service --build-arg SERVICE_PORT=8083"
require_literal "$ROOT_DIR/deployments/tekton/release-service-preproduction-build-pipelinerun.yaml" "release-service PipelineRun service label" "service: release-service"
require_literal "$ROOT_DIR/deployments/tekton/release-service-pipeline-run-template.yaml" "release-service template service label" "service: release-service"
require_literal "$ROOT_DIR/deployments/tekton/runtime-service-preproduction-build-pipelinerun.yaml" "runtime-service PipelineRun build args" "SERVICE_NAME=runtime-service --build-arg SERVICE_PORT=8084"
require_literal "$ROOT_DIR/deployments/tekton/runtime-service-pipeline-run-template.yaml" "runtime-service template build args" "SERVICE_NAME=runtime-service --build-arg SERVICE_PORT=8084"
require_literal "$ROOT_DIR/deployments/tekton/runtime-service-preproduction-build-pipelinerun.yaml" "runtime-service PipelineRun service label" "service: runtime-service"
require_literal "$ROOT_DIR/deployments/tekton/runtime-service-pipeline-run-template.yaml" "runtime-service template service label" "service: runtime-service"
