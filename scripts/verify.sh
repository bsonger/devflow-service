...
require_file "$ROOT_DIR/docs/system/domain-model.md" "system domain model doc"
...
require_file "$ROOT_DIR/docs/api/README.md" "api docs README"
require_file "$ROOT_DIR/docs/api/contract-guide.md" "api contract guide"
require_file "$ROOT_DIR/docs/guides/README.md" "guides README"
require_file "$ROOT_DIR/docs/guides/local-development.md" "local development guide"
require_file "$ROOT_DIR/docs/guides/backend-change-playbook.md" "backend change playbook"
require_file "$ROOT_DIR/docs/guides/openapi-workflow.md" "openapi workflow guide"
...
require_dir "$ROOT_DIR/docs/api" "api docs directory"
require_dir "$ROOT_DIR/docs/guides" "guides docs directory"
