...
- active runtime-domain storage and request handling are PostgreSQL-free
- runtime observer state is rebuilt in-process after restart from Kubernetes observation and may be temporarily empty until sync completes
