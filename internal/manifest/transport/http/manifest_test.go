...
func TestCreateManifestReturnsCreated(t *testing.T) {
	...
	if payload.Data.Name != "portal-api-demo@sha256:abc" {
		t.Fatalf("name = %q want %q", payload.Data.Name, "portal-api-demo@sha256:abc")
	}
...
func TestListManifestsIncludesApplicationNamePrefixInManifestName(t *testing.T) {
	gin.SetMode(gin.ReleaseMode)
	applicationID := uuid.MustParse("11111111-1111-1111-1111-111111111111")
	handler := &ManifestHandler{
		svc: stubManifestService{
	...
	if payload.Data[0].Name != "portal-api-20260524-000001" {
		t.Fatalf("name = %q want %q", payload.Data[0].Name, "portal-api-20260524-000001")
	}
}

func TestGetManifestFallsBackToBaseManifestNameWhenApplicationLookupFails(t *testing.T) {
	gin.SetMode(gin.ReleaseMode)
	...
	if payload.Data.Name != "demo-api@sha256:abc" {
		t.Fatalf("name = %q want %q", payload.Data.Name, "demo-api@sha256:abc")
	}
}
